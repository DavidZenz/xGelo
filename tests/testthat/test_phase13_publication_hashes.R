...
phase13_publication_test_seed <- function() {
  ...
  source_fixtures <- phase13_publication_test_read_csv(file.path(accepted_root, nl, "fixtures.csv"))
  ...
  source_results <- phase13_publication_test_read_csv(file.path(accepted_root, nl, "results.csv"))

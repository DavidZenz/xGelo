...
test_that("dashboard data export includes probabilities, scorelines, and bracket paths", {
  ...
  expect_true(grepl("bracket-tooltip-portal", html, fixed = TRUE))
  expect_true(grepl("setupBracketTooltipPortal", html, fixed = TRUE))
  expect_true(grepl("positionBracketTooltipPortal", html, fixed = TRUE))
  expect_true(grepl("padding:34px 20px 30px", html, fixed = TRUE))
  expect_false(grepl("padding:34px 20px 420px", html, fixed = TRUE))
  expect_true(grepl("mouseover", html, fixed = TRUE))
  expect_true(grepl("keydown", html, fixed = TRUE))
  expect_true(grepl("Escape", html, fixed = TRUE))
  ...
  expect_true(grepl("z-index:100000", html, fixed = TRUE))

...
| A3 | Resolved: the eight-file outcomes schema, statuses, and completed-score fields are the SIM-01 planning contract. | Planning Resolution / Validation | Later dashboard consumers must use the manifest and status contract rather than infer fields. |

...
| 12-05-01 | 06 | 6 | PROMO-03 | N/A | Staged release contains model object, model contract, manifests, report, model card, provenance, limitations, reproducibility metadata, and hashes | contract | Phase 12 quick command; `test_phase12_release.R` | Yes - W0 | pending |
| 12-06-01 | 07 | 7 | PROMO-03 | N/A | Dashboard/export resolution fails closed on absent, unapproved, or hash-mismatched release artifacts | regression | Phase 12 quick command; `test_phase12_release.R` and `test_worldcup_dashboard.R` | Yes - W0 | pending |
| 12-06-02 | 07 | 7 | PROMO-03 | N/A | No-promotion release states `incumbent retained` and remains consumable through the approved contract | contract | Phase 12 quick command; `test_phase12_release.R` | Yes - W0 | pending |

...
- **At Task 14-05-01:** Start a fresh R process and run complete calibration-revision manifest/hash/identity validation before accepting the resume signal.
...
All Phase 14 behaviors have automated verification. Task 14-05-01 is a blocking human resume checkpoint, but its acceptance evidence is the fresh-process automated calibration manifest/hash/identity command; the human cannot override a failed result.

## Internal Map Validation

- [x] 37 unique final task IDs found across 20 plans.
- [x] 37 per-task rows present above; every row has an exact automated command.
...
| REQ | FORECAST-01 | Approved calibrated release with model identity, model_data_cutoff, and feature cutoff. | 14-02, 14-04 through 14-09, 14-16 through 14-20 | COVERED |
...
| RESEARCH | R-01 | Empirical calibration is pass-or-block; thresholds and final-label boundary remain unchanged. | 14-04/05 | COVERED |
...
| CONTEXT | D-14 | Contract-controlled calibrated consumer 1X2 retains raw audit values. | 14-03, 14-06, 14-16/17 | COVERED |
| CONTEXT | D-15 | Narrow calibrated release revision and atomic dual registry repin. | 14-04 through 14-09 | COVERED |

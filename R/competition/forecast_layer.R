...
phase14_forecast_batch_top10 <- function(forecast_row, grid, top_n = 10L) {
  ...
  output <- data.frame(
    ...
    release_selector_sha256 = as.character(forecast_row$release_selector_sha256[[1L]]),
    model_id = as.character(forecast_row$model_id[[1L]]),
    model_sha256 = as.character(forecast_row$model_sha256[[1L]]),
    calibrator_id = as.character(forecast_row$calibrator_id[[1L]]),
    calibrator_sha256 = as.character(forecast_row$calibrator_sha256[[1L]]),
